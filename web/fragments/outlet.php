    ...
    <div class="container">
        <div class="row justify-content-center section-heading">
            <div class="col-lg-6 text-center">
                <h4 class="m-0">Outlet Jayor</h4>
                <h6 class="h6 mt-2 fw-normal">Productos con precio especial por corta caducidad o temporada.</h6>
            </div>
        </div>
        <div class="row g-3 g-lg-4">
            <!-- Product Box -->
            <?php foreach ($outletProducts as $product): ?>
                        ...
                        <div class="product-card-image">
                            ...
                            <div class="product-media">
                                ...
                                <div class="product-cart-btn">
                                    <a href="<?php echo $viewsPath; ?>product-detail?g=<?php echo htmlspecialchars($product['product_group']); ?>"
                                       class="btn btn-jy-primary btn-sm w-100 btn-quotation">
                                        Ver detalles
                                    </a>
                                </div>
                            </div>

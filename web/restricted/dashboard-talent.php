...
<html lang="es-MX">
    ...
    <body>
                        ...
                        <div class="row counter">
                            <div class="col-6 col-md-4 col-lg mb-3">
                                <div class="counter-col-02 d-flex justify-content-center">
                                    <div class="cc-icon">
                                        <i class="fas fa-user theme-color"></i>
                                    </div>
                                    <div class="count-data">
                                        <div id="talent-count" class="count dark-color"></div>
                                        <h6>Talento</h6>
                                    </div>
                                </div>
                            </div>                            
        ...
        <script src="../../assets/js/dashboard-talent.js" type="text/javascript"></script>
    </body>
</html>